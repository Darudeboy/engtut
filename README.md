...
Персональный AI-тьютор по английскому и итальянскому языкам для начинающих. Бот ведёт от пассивного понимания к активному использованию через микро-шаги.

## Возможности

- Выбор программы: 🇬🇧 английский или 🇮🇹 итальянский
...
- 📰 Одноразовые заметки обновления и команда `/whatsnew`
- 📊 Честные статусы слов, прогресс, streak, достижения, недельная сводка
- ⏰ Напоминания о занятиях

У каждого языка собственные уровень CEFR, словарь, история уроков,
экзамены и контекст AI-наставника. Переключить программу можно кнопкой
`🌐 Язык` в главном меню без потери прогресса другого языка.
...
| `/whatsnew` | Последние изменения в боте |
